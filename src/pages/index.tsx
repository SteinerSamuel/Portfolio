    ...
    <div >
      ...
      <div className="drawer">
        ...
        <div className="drawer-content flex flex-col md:flex-row">
          ...
          {/* Socials */}
          <div className="hidden md:flex flex-row flex-3 items-center justify-center m-0 space-x-3">
            <button>
              <svg className="fill-gray-600 hover:fill-gray-400" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                <path d="M2.846 6.887c.03-.295-.083-.586-.303-.784l-2.24-2.7v-.403h6.958l5.378 11.795 4.728-11.795h6.633v.403l-1.916 1.837c-.165.126-.247.333-.213.538v13.498c-.034.204.048.411.213.537l1.871 1.837v.403h-9.412v-.403l1.939-1.882c.19-.19.19-.246.19-.537v-10.91l-5.389 13.688h-.728l-6.275-13.688v9.174c-.052.385.076.774.347 1.052l2.521 3.058v.404h-7.148v-.404l2.521-3.058c.27-.279.39-.67.325-1.052v-10.608z"/>
              </svg>
            </button>
            <button>
              <svg className="fill-gray-600 hover:fill-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div className="Content overflow-x-hidden w-screen">
              <div className="w-screen h-screen snap snap-y snap-mandatory overflow-scroll overflow-x-hidden">
                ...
                <div className="w-scren h-screen snap-center bg-blue-400" id="About">
                  About
                </div>
                <div className="w-screen h-screen snap-center bg-white" id="Projects">
                  Projects
                </div>
                <div className="w-screen h-screen snap-center bg-pink-400" id="Research">
                  Research
                </div>
              </div>
          </div>
